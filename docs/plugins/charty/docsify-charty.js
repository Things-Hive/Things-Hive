...
function charty(hook, vm) {
    ...
    hook.afterEach(function (html, next) {
        ...
        htmlElement.querySelectorAll('pre[data-lang=charty]').forEach(function (element) {
            ...
            Legend.setAttributeNS('charty', // namespace
                'class', // attribute
            ...
            svg.appendChild(Legend); // -- legend things
            // only if not rating
            ...
            if (chartyJSONOptionsLegend && !['rating'].includes(chartyType)) {
                ...
                Legend.appendChild(legend); // add the title
            ...
            if (charty) {
                ...
                chartyHeader = chartyJSON.title === '' || !chartyJSON.title ? '' : "<h3><p align=center>".concat(chartyJSON.title, "</p></h3>"); // add the caption (if present)
